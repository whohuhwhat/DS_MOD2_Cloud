...
Cloud computing has become more cost efficient, secure and reliable.  It saves costs on infrastructure and helps speed up computing tasks such as dealing with very large sets of data.  This led me to ask, is there a difference in performance and price between cloud service providers?
